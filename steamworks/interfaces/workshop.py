...
class SteamWorkshop(object):
    ...
    _RemoteStorageSubscribePublishedFileResult_t = CFUNCTYPE(
        None, RemoteStorageSubscribePublishedFileResult_t
    )
    _RemoteStorageUnubscribePublishedFileResult_t = CFUNCTYPE(
        None, RemoteStorageUnubscribePublishedFileResult_t
    )
    ...
    def SetItemSubscribedCallback(self, callback: object) -> bool:
        ...
        self.steam._cdll.Workshop_SetItemSubscribedCallback(
            self._RemoteStorageSubscribePublishedFileResult
        )
        return True
    ...
    def SetItemUnubscribedCallback(self, callback: object) -> bool:
        ...
        :return: bool
        """
        self._RemoteStorageUnubscribePublishedFileResult = (
            self._RemoteStorageUnubscribePublishedFileResult_t(callback)
        )
        self.steam._cdll.Workshop_SetItemUnubscribedCallback(
            self._RemoteStorageUnubscribePublishedFileResult
        )
        return True
    ...
    def GetItemUpdateProgress(self, update_handle: int) -> dict:
        ...
        update_status = self.steam.Workshop_GetItemUpdateProgress(
            update_handle, punBytesProcessed, punBytesTotal
        )
        ...
        return {
            ...
            "progress": (
                punBytesProcessed.contents.value / punBytesTotal.contents.value
            ),
        }
    ...
    def GetSubscribedItems(self, max_items: int = 0) -> list:
        ...
        actual_item_count = Steam.cdll.Workshop_GetSubscribedItems(
